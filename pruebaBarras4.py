...
def InicioSesión():
    ...
    bIniciar = PhotoImage(file='Images/P1_inciarsesionbttn.png')
    btIniciar = Button(ventIni, text='Iniciar', image=bIniciar, height="50", width="216", command=volver3)
    btIniciar.place(x=36.4, y=680)

    bCancelar2 = PhotoImage(file='Images/P1_cancelarbttn.png')
    btCancelar2 = Button(ventIni, text='Cancelar', image=bCancelar2, height="50", width="216", command=volver3)
    btCancelar2.place(x=287.6, y=680)

    EntryNombre1 = Entry(ventIni, font = "Arial 20")
    EntryNombre1.place(x=45.2, y=520,relheight=0.04,relwidth=0.8)
    
    EntryContraseña1 = Entry(ventIni, font = "Arial 20")
    EntryContraseña1.place(x=45.2, y=620,relheight=0.04,relwidth=0.8)
...
def RegistroCompletado():
    ...
    if len(nombre)==0 or len(apellido)==0 or len(contraseña)==0:
        ...
        f = open(f"{OutFolderUser}/{nombre}_{apellido}.txt ", "w")
        f.write(nombre + ',')
        f.write(apellido + ',')
        f.write(contraseña)
        f.write(a)
        ...
        print(a)
        with open(f"{OutFolderBarcode}/{nombre}_{apellido}.png ", "wb") as f:
            EAN13(a, writer=ImageWriter()).write(f)
        transicion()

def Generado():
    global nombre, ventGen
    ventGen = Tk()
    ...
    imagen4 = cv2.imread(f"{OutFolderBarcode}/{nombre}_{apellido}.png")
    ...
    btGuardar = Button(ventGen, text='Guardar', image=bGuardar, height="51", width="453", command=volver2)
...
def INICIO():
    ...
    OutFolderBarcode='C:/Users/yuzod/OneDrive/Escritorio/Python/Lector de Barras/Data/Barcode'
    OutFolderScan='C:/Users/yuzod/OneDrive/Escritorio/Python/Lector de Barras/Data/Scan'
    OutFolderUser = 'C:/Users/yuzod/OneDrive/Escritorio/Python/Lector de Barras/Data/User'
    UserCheck = 'C:/Users/yuzod/OneDrive/Escritorio/Python/Lector de Barras/Data/User/'
    data=[]
